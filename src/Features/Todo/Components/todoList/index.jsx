...
export default function TodoList() {
  ...
  //Filter data
  const todoFilter = Todo.filter((todo) => Filter === 'all' || Filter === todo.isComplete);

  const handleSubmit = ({ title }) => {
    // console.log('cha nhan duoc roi', title);
    const newTodo = { id: Todo.length + 1, title: title, isComplete: 'new' };
